...
export function getUpdatedFunctionsTest() {
    fullTest();
    //oneTest(existingFile7, snippet7);
}
function oneTest(existingFile: string, snippet: string) {
    getUpdatedFile(existingFile, snippet, "src/app/page.jsx");
...
function fullTest() {
    ...
    for (const test of tests) {
        updatedFiles.push(getUpdatedFile(test[0], test[1], "src/app/page.jsx"))
    }
